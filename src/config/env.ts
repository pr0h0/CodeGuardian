...
const envSchema = z.object({
  ...
  CODEGUARDIAN_AI_AUDIT_MAX_FILES: z.coerce.number().int().positive().default(100),
  CODEGUARDIAN_AI_AUDIT_MAX_ROUNDS: z.coerce.number().int().positive().default(30),
  CODEGUARDIAN_AI_AUDIT_MAX_CHARS: z.coerce.number().int().positive().default(500_000),
